const CACHE = 'bridgeaid-v11';
const ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=11',
  './js/app.js?v=11',
  './js/localization.js?v=11',
  './data/resources.js?v=11',
  './manifest.webmanifest',
  './js/services/storage.js',
  './js/services/resource-service.js?v=11',
  './js/services/location-service.js?v=11',
  ...
  './js/services/grounded-assistant.js?v=11',
  './js/services/local-eligibility-service.js?v=11',
