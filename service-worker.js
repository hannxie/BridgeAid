const CACHE = 'bridgeaid-v10';
const ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=10',
  './js/app.js?v=10',
  './js/localization.js?v=10',
  './data/resources.js?v=10',
  './manifest.webmanifest',
  './js/services/storage.js',
  './js/services/resource-service.js?v=10',
  './js/services/location-service.js?v=10',
  ...
  './js/services/grounded-assistant.js?v=10',
  './js/services/local-eligibility-service.js?v=10',
